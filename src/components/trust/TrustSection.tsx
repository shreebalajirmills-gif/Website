    ...
    <section id="trust-credibility" className="py-28 bg-steel-base border-b border-steel-200 relative steel-grid-pattern overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="card-base liquid-glass-project p-6 space-y-3">
          ...
          <div className="card-base liquid-glass-contractor p-6 space-y-3">
            <div className="w-10 h-10 bg-transparent group-hover:bg-growth-50 text-steel-900 border border-steel-200 group-hover:border-growth-400 flex items-center justify-center">
          ...
          <div className="card-base liquid-glass-distributor p-6 space-y-3">
            <div className="w-10 h-10 bg-transparent group-hover:bg-transparent group-hover:bg-growth-50 text-steel-900 border border-steel-200 group-hover:border-growth-400 flex items-center justify-center">
          ...
          <div className="card-base liquid-glass-investor p-6 space-y-3">
            <div className="w-10 h-10 bg-transparent group-hover:bg-transparent group-hover:bg-growth-50 text-steel-900 border border-steel-200 group-hover:border-growth-400 flex items-center justify-center">
        ...
        <div className="card-base card-product p-8 border border-steel-200 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {CERTIFICATIONS.map((cert) => (
              <div key={cert.id} className="p-5 bg-steel-50 border border-steel-200 flex flex-col sm:flex-row items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  <div className="p-2.5 bg-transparent group-hover:bg-transparent group-hover:bg-growth-50 border border-steel-200 group-hover:border-growth-400 text-steel-900 shrink-0">
                    <CheckCircle className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="font-bold text-steel-900 text-sm">{cert.name}</h4>
                      <span className="badge-contractor px-2.5 py-0.5 text-[10px] font-black font-mono">
                        {cert.code}
                      </span>
                    </div>
                  ...
                  onClick={() => {
                    downloadDynamicPdf(
                      ...
                      [
                        ...
                        `Holder: Shree Balaji Rolling Mills Limited`,
                ...
                >
                  <Download className="w-3.5 h-3.5 text-steel-900" />
        ...
        <div className="card-base card-product p-8 border border-steel-200">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {CLIENT_LOGOS.map((client) => (
              <div
                key={client.id}
                className="badge-base p-4 text-center space-y-1.5 flex flex-col items-center justify-center min-h-[105px] hover:border-growth-500 transition-colors"
              >
